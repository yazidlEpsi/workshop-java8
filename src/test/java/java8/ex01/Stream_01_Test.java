...
public class Stream_01_Test {
    ...
    public void test_stream_anyMatch() throws Exception {
        ...
        // TODO valider si au moins une pizza à un prix >= 1300t-> t.getPrice() >= 1300
         Boolean result1 = pizzas.stream().anyMatch(t-> t.getPrice() >= 1300);

        // TODO valider si au moins une pizza à un prix >= 2000
        Boolean result2 = pizzas.stream().anyMatch(t-> t.getPrice() >= 2000);;
    ...
    public void test_stream_allMatch() throws Exception {
        ...
        Boolean result1 = pizzas.stream().allMatch(t-> t.getPrice() >= 1300);

        // TODO valider que toutes les pizzas ont un prix >= 900
        Boolean result2 = pizzas.stream().allMatch(t-> t.getPrice() >= 900);
    ...
    public void test_stream_noneMatch() throws Exception {
        ...
        Boolean result1 = pizzas.stream().noneMatch(t-> t.getPrice() >= 2000);
    ...
    public void test_stream_filter_and_match() throws Exception {
        ...
        List<Order> result = orders.stream()
        		.filter(t-> t.getCustomer().getFirstname().equals("Johnny"))
        		.filter(t-> t.getPizzas().stream()
        				.anyMatch(p-> p.getPrice() >= 1300)).collect(Collectors.toList());
    ...
    public void test_stream_findFirst() throws Exception {
        ...
        Optional<Order> result =  orders.stream()
        		.filter(t-> t.getCustomer().getFirstname().equals("Sophie"))
        		.findFirst();
